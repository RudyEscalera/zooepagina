class AdopcionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @adopcion.save
        format.html { redirect_to @adopcion, notice: 'Adopcion was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @adopcion.update(adopcion_params)
        format.html { redirect_to @adopcion, notice: 'Adopcion was successfully updated.' }
  ...
  private
    ...
    def adopcion_params
      params.require(:adopcion).permit(:numero_adultos, :numero_ninios, :numero_perros, :numero_gatos, :numero_otros, :referencia_casa, :numero_referencia1, :numero_referencia2)
    end
end
