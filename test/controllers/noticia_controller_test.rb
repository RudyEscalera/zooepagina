...
class NoticiaControllerTest < ActionController::TestCase
  ...
  test "should create noticium" do
    assert_difference('Noticium.count') do
      post :create, noticium: { categoria: @noticium.categoria, contenido: @noticium.contenido, titulo: @noticium.titulo }
    end
  ...
  test "should update noticium" do
    patch :update, id: @noticium, noticium: { categoria: @noticium.categoria, contenido: @noticium.contenido, titulo: @noticium.titulo }
    assert_redirected_to noticium_path(assigns(:noticium))
  end
