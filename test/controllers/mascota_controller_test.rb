...
class MascotaControllerTest < ActionController::TestCase
  ...
  test "should create mascotum" do
    assert_difference('Mascotum.count') do
      post :create, mascotum: { anti: @mascotum.anti, color: @mascotum.color, depar: @mascotum.depar, edad: @mascotum.edad, especie: @mascotum.especie, estado: @mascotum.estado, esterilizacion: @mascotum.esterilizacion, hexa: @mascotum.hexa, nombre: @mascotum.nombre, observacion: @mascotum.observacion, octa: @mascotum.octa, raza: @mascotum.raza, sexo: @mascotum.sexo }
    end
  ...
  test "should update mascotum" do
    patch :update, id: @mascotum, mascotum: { anti: @mascotum.anti, color: @mascotum.color, depar: @mascotum.depar, edad: @mascotum.edad, especie: @mascotum.especie, estado: @mascotum.estado, esterilizacion: @mascotum.esterilizacion, hexa: @mascotum.hexa, nombre: @mascotum.nombre, observacion: @mascotum.observacion, octa: @mascotum.octa, raza: @mascotum.raza, sexo: @mascotum.sexo }
    assert_redirected_to mascotum_path(assigns(:mascotum))
  end
